...
/**
 * 简易 shadcn 风格 Select：从 options 数组快速渲染。
 *
 * 保留旧版 Select 的 options/placeholder/value/onChange 风格，
 * 内部使用 Radix Select 实现。同时支持 value / defaultValue。
 */
export interface ShadcnSelectProps {
  ...
  disabled?: boolean;
  className?: string;
  /** 透传 Radix Select Root 的额外属性，例如 name */
  name?: string;
}
