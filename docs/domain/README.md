...
> - [产品级需求基线](../requirements/product/README.md) — 产品范围、漫剧专业需求、用户旅程、权限矩阵和交付门禁；产品决策确认后再变更领域契约。
...
### 基础规范
- [统一语言术语表](03-glossary.md) — 代码、UI、API 中使用的全部业务概念和状态术语
- [上下文映射](04-context-map.md) — 10 个限界上下文的边界、上下游关系和共享内核
- [跨上下文协作契约](05-contracts.md) — 事件链、消费者注册表、防腐层、CQRS 投影
- [统一错误与 HTTP 响应契约](08-error-contract.md) — 字符串错误码、HTTP 映射、响应 envelope 和旧数字码迁移
- [模块-上下文映射表](06-module-map.md) — 页面到上下文和聚合根的对应关系
...
### 迭代与基础设施
- [迭代优先级](10-iteration-priority.md) — 聚合实现优先级与建议迭代节奏
...
| 角色 | 推荐阅读顺序 |
|------|-------------|
| 架构师 | [上下文映射](04-context-map.md) → [依赖方向约束](09-dependency-rules.md) → [跨上下文协作契约](05-contracts.md) |
| 后端开发 | [统一语言术语表](03-glossary.md) → 你负责的上下文文件 → [公共领域基础设施](07-infrastructure.md) |
| 前端开发 | [模块-上下文映射表](06-module-map.md) → [统一语言术语表](03-glossary.md) → 对应上下文 |
| 产品经理 | [统一语言术语表](03-glossary.md) → [模块-上下文映射表](06-module-map.md) → [迭代优先级](10-iteration-priority.md) |
| 测试工程师 | 你负责的上下文文件 → [依赖方向约束](09-dependency-rules.md) |
