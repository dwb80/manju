...
> 共享规则见 [01-common-contract.md](01-common-contract.md)。本册覆盖 US-013～US-017、US-021。

## US-013 音频管理

参数、声音授权、ASR、口型驱动和质量规则以[AI音频、TTS与音频驱动参数规范](../requirements/modules/08-ai-audio-config.md)为权威。
